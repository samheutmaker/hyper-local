...
var sessionSchema = mongoose.Schema({
  ...
  numberOfEventsViewed: Number, // Number of events viewed during session
  eventsViewed: Array, // Array of id's of the viewed events,
...
var userAnalyticsSchema = mongoose.Schema({
  ...
  numberOfEventsViewed: Number, // The total number of events viewed
